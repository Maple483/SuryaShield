...
MASTER_PATH = (
    ...
    r"\Dataset\Master_Dataset_1996_2025.csv"
)
...
if section == "Visualization":
    ...
    # ========================================================
    # EXPLORE INDIVIDUAL ICME
    # ========================================================

    st.subheader(
        "Explore an Individual ICME"
    )


    st.write(
        "Select the date of the ICME you want to explore."
    )
    ...
    if available_dates:
        ...
        if len(date_events) == 0:
            ...
            st.warning(
                "No ICME event found for this date."
            )
        ...
        st.subheader(
            "First 3 Hours of Solar-Wind Parameters"
        )
    ...
    # Your previously calculated results
    ...
    st.caption(
        ...
        "Interpretation: a positive permutation importance "
        "means that randomly disrupting the feature reduced "
        "model ROC-AUC, suggesting that the model relies on "
        "that feature. Values close to zero indicate little "
        "additional predictive contribution, while negative "
        "values can occur when permutation happens to improve "
        "performance because of sampling variability or "
        "feature redundancy."
    )
...
if section == "Prediction":
    ...
    if predict_button:
        ...
        try:
            ...
            # =================================================
# GEOEFFECTIVENESS PROBABILITY GAUGE
# =================================================

            st.subheader(
                "Probability of Geoeffectiveness"
            )
            ...
            gauge = go.Figure(
                ...
                go.Indicator(
                    ...
                    gauge={
                        ...
                        # Current probability pointer
                        "bar": {
                            "color": "#333333"
                        },

                        # LSTM classification threshold
                        "threshold": {
...
def explain_prediction(
    ...
    """
    Measures how sensitive the LSTM prediction is
    to each feature.

    input_data:
        Original 3-hour input dataframe.

    For each feature:
        - Keep all other features unchanged.
        - Shuffle that feature across the 3 hours.
        - Recalculate the prediction.
        - Measure the change in probability.
    """
    ...
    for feature_index, feature in enumerate(features):
        ...
        for _ in range(n_repeats):
            ...
            # ----------------------------------------------
            # Shuffle only this feature across 3 hours
            # ----------------------------------------------

            original_values = (
                X_perturbed[0, :, feature_index]
                .copy()
            )
